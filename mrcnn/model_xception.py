...
class MaskRCNN:
    ...
    def train(self, train_dataset, val_dataset, learning_rate, init_epoch, epochs, layers,
        ...
        stage_regex = {}
        if self.config.BACKBONE in ["resnet50", "resnet101", "xception"]:
    ...
    def detect(self, images, verbose=0):
        ...
        for i, image in enumerate(images):
            final_rois, final_class_ids, final_scores, final_masks, final_segmentations = \
            ...
            results.append({
                ...
                "scores": final_scores,
                "masks": final_masks,
                "segmentations": final_segmentations,
            })
        return results
